...
As previously mentioned :ref:`KV Store lookup`  :doc:`KV Store lookup <../overview>` , this alert looks for active alerts, performs the automatic checks :ref:`Automatic Checks` and save the result to a KV store lookup.
