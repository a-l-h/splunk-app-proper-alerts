...
As previously mentioned  :ref:`anchor text <kv-store-lookup>`  , this alert looks for active alerts, performs the automatic checks :ref:`Automatic Checks` and save the result to a KV store lookup.
