...
1.	Install the App on your Splunk Search Head(s) [test] (https://docs.splunk.com/Documentation/Splunk/latest/Admin/Deployappsandadd-ons#Deployment_architectures)
